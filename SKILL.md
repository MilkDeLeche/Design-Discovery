...
> **Locate → Read → Gauge openness → Propose directions (one bolder than asked) → Converge → Build → Verify against the real element → Offer to push further.**
